...
public class RWFile {
    ...
    public RWFile() {
        /*
        Ruta raiz donde están ubicados los ficheros.
         */
        rootDir = Gestion.ROOTDIR;
    }

    public Deque fileList() {
    ...
    public Queue loadFile(String file) {
    ...
    public void createFile(Queue quFile, String file, boolean addAtEnd) {
        try {
